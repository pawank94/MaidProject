...
public class ListDataAdapter extends RecyclerView.Adapter<ListDataAdapter.ViewHold>{
    private Context ctx;
    private View parentView,listView;
    private ArrayList<ShoppingListItem> array;
    private ShoppingListAdapter.ViewHold vh;
    ...
    private ImageButton cancelItem;
    private TextView bought_by_name;
    private String HINT="Enter Item Name";

    public ListDataAdapter(Context ctx, View v, ShoppingListAdapter.ViewHold holder, View listView, ArrayList<ShoppingListItem> items) {
        this.ctx=ctx;
        this.parentView = v;
        this.vh = holder;
    ...
    public void onBindViewHolder(ViewHold holder,final int position) {
        ...
        {
            case "VEGGY":
                holder.itemName.setTextColor(ctx.getColor(R.color.veggy_color));
                break;
            case "STAPLE":
                holder.itemName.setTextColor(ctx.getColor(R.color.staple_color));
                break;
            case "UTILITY":
                holder.itemName.setTextColor(ctx.getColor(R.color.utilities_color));
                break;
            default:
